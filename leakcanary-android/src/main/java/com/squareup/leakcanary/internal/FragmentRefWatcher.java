...
public interface FragmentRefWatcher {
    ...
    final class Helper {
        ...
        public static void install(Context context, RefWatcher refWatcher) {
            ...
            try {
                /**
                 * 反射得到FragmentRefWatcher接口的实现类SupportFragmentRefWatcher
                 *
                 * link{@com.squareup.leakcanary.internal.SupportFragmentRefWatcher}
                 */
        ...
        //通过Activit的生命周方法onActivityCreated，检测Fragment
